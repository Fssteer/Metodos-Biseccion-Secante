            ...
            rx.box(
                    ...
                    rx.flex(
                        rx.flex(
                            ...
                            rx.box(
                                rx.text("Métodos Numéricos", font_size="22px",
                                        font_weight="600", color=TEXT_PRI, letter_spacing="0.01em"),
                                rx.text("Universidad de Panamá · Ing. Informática",
                                        font_size="15px", color=GREEN_MID, margin_top="2px"),
                            ),
                    ...
                    # ── Footer ──
                    rx.flex(
                        rx.text("Desarrollado por Felix Samudio",
